...
//Тут мы отсчитываем сколько круглых недель с прошло с начала курсов, столько и KPI у нас будет

let beginOfCourses = 2021 * 365 + 9 * 30 + 6//начало курсов в днях (6 сентября 2021)
let today = new Date();
...
let divKpi = $('.div-kpi')
let countOwWeeks = Math.round((todayCountDays - beginOfCourses) / 7 - 1) //сколько недель прошло ровно!
